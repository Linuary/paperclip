        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {t("dashboard.activeIncident", { count: data.budgets.activeIncidents })}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {t("dashboard.budgetIncidentDetails", { pausedAgents: data.budgets.pausedAgents, pausedProjects: data.budgets.pausedProjects, pendingApprovals: data.budgets.pendingApprovals })}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.agentsDescription", { running: data.agents.running, paused: data.agents.paused, errors: data.agents.error })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.tasksDescription", { open: data.tasks.open, blocked: data.tasks.blocked })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? t("dashboard.monthSpendDescription", { percent: data.costs.monthUtilizationPercent, budget: formatCents(data.costs.monthBudgetCents) })
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? t("dashboard.pendingApprovalsDescription", { count: data.budgets.pendingApprovals })
