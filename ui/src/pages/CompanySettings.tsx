          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  {brandColor && (
                    ...
                    >
                      {t("companySettings.clearBrandColor")}
                    </Button>
                  )}
                </div>
              </Field>
              <Field
                ...
                hint={t("companySettings.attachmentSizeHint", { max: MAX_COMPANY_ATTACHMENT_MAX_MIB })}
              >
                <div className="flex flex-col gap-1.5">
                  ...
                  {!attachmentMaxValid && (
                    <span className="text-xs text-destructive">
                      {t("companySettings.attachmentSizeError", { max: MAX_COMPANY_ATTACHMENT_MAX_MIB })}
                    </span>
                  )}
                </div>
              </Field>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            {t("companySettings.packagesMoved")}
          </p>
