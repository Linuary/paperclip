...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("goal.title"), href: "/goals" },
      { label: goal?.title ?? goalId ?? t("goal.title") }
    ]);
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            {t("goal.subGoalsCount", { count: childGoals.length })}
          </TabsTrigger>
          <TabsTrigger value="projects">
            {t("goal.projectsCount", { count: linkedProjects.length })}
          </TabsTrigger>
        </TabsList>
