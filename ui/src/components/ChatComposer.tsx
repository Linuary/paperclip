...
export const ChatComposer = forwardRef<ChatComposerHandle, ChatComposerProps>(function ChatComposer(
  ...
  const effectivePlaceholder = placeholder ?? t("chatComposer.placeholder");
  const effectiveSendLabel = sendLabel ?? t("chatComposer.sendLabel");
          ...
          {attachments.map((attachment) => {
            ...
            const statusLabel =
              attachment.status === "uploading"
                ? t("chatComposer.uploading")
                : attachment.status === "error"
                  ? attachment.error ?? t("chatComposer.uploadFailed")
                  : attachment.inline
                    ? t("chatComposer.insertedInline")
                    : t("chatComposer.attached");
            return (
              <div
                key={attachment.id}
                className={cn(
