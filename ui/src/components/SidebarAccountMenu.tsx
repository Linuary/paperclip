          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              <MenuAction
                ...
                description={t("sidebar.openActivityTaskLedger")}
                icon={UserRound}
                href={profileHref}
              ...
              <MenuAction
                ...
                description={t("sidebar.updateDisplayNameAvatar")}
                icon={UserRoundPen}
              ...
              <MenuAction
                ...
                description={t("sidebar.openDocsNewTab")}
                icon={BookOpen}
                href={DOCS_URL}
                external
              ...
              <MenuAction
                ...
                description={t("sidebar.shareFeedback")}
                icon={Megaphone}
                href={FEEDBACK_URL}
                external
                onClick={() => setOpen(false)}
