...
export function NewGoalDialog() {
  ...
  const levelLabels: Record<string, string> = {
    company: t("goal.dialog.levelCompany"),
    team: t("goal.dialog.levelTeam"),
    agent: t("goal.dialog.levelAgent"),
    task: t("goal.dialog.levelTask"),
  };
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("goal.dialog.creating") : newGoalDefaults.parentId ? t("goal.dialog.createSubGoal") : t("goal.dialog.createGoal")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
